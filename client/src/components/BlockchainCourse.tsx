...
const COURSE_MODULES: CourseModule[] = [
    ...
    content: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: "LuvChain is the L.A.W.S. Collective's native blockchain designed for business formation, certificate issuance, trust management, and token economics. All your course completions, business documents, and financial transactions are recorded immutably on LuvChain.",
          tips: [
      ...
      keyTakeaways: [
        ...
        "LuvChain powers the L.A.W.S. Collective ecosystem",
  ...
  },
  {
    ...
    content: {
      questions: [
        ...
        {
          question: "What is LuvChain used for in the L.A.W.S. Collective?",
          options: [
            "A) Social media only",
    ...
    content: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: "LUV is the native token of the L.A.W.S. Collective ecosystem. You earn LUV by completing courses, contributing to the community, and achieving milestones. LUV can be used for services, governance voting, and accessing premium features.",
          tips: [
  ...
  },
  {
    ...
    content: {
      questions: [
        {
          question: "How do you earn LUV tokens in the L.A.W.S. Collective?",
          options: [
