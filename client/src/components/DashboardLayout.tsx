...
// Finance Department (Craig Russell)
      ...
      // Platform Administration (Open)
      {
        ...
        items: [
          ...
          { icon: Rocket, label: "System Activations", path: "/admin/activations", minRole: "admin" },
          { icon: Wrench, label: "Support Log", path: "/admin/support-log", minRole: "admin" },
        ]
      },
      // Grants & Funding
      {
                    ...
                    <SidebarMenuItem>
                      ...
                      <CollapsibleContent>
                        <SidebarMenuSub>
                          ...
                          {/* SubCategories (for The L.A.W.S. Collective departments) */}
