...
export default function PlatformAdminDashboard() {
  ...
  const documents = [
    { name: "Platform Architecture", type: "Technical", date: "Jan 2026", size: "2.3 MB" },
    { name: "API Documentation", type: "Technical", date: "Jan 2026", size: "1.8 MB" },
    { name: "User Management Guide", type: "Guide", date: "Dec 2025", size: "456 KB" },
    { name: "Security Configuration", type: "Policy", date: "Jan 2026", size: "234 KB" },
    { name: "Backup Procedures", type: "Procedure", date: "Dec 2025", size: "189 KB" },
    { name: "Deployment Guide", type: "Technical", date: "Jan 2026", size: "567 KB" },
  ];
          ...
          <TabsContent value="documents" className="space-y-4 mt-4">
            <Card className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-semibold text-foreground">Platform Document Repository</h3>
