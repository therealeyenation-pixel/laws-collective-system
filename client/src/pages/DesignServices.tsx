...
export default function DesignServices() {
  ...
  const { data: packages, isLoading: packagesLoading } = trpc.serviceBilling.getDesignPackages.useQuery();
  const { data: invoices, isLoading: invoicesLoading, refetch: refetchInvoices } = trpc.serviceBilling.getInvoices.useQuery({ serviceType: "design" });
  const { data: stats } = trpc.serviceBilling.getBillingStats.useQuery({ serviceType: "design" });
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Professional design services with member pricing
            </p>
          </div>
          <Dialog open={isInvoiceDialogOpen} onOpenChange={setIsInvoiceDialogOpen}>
            ...
            <DialogContent className="max-w-lg">
              <DialogHeader>
                <DialogTitle>Create Design Invoice</DialogTitle>
                <DialogDescription>
                  Generate an invoice for design services
                </DialogDescription>
              </DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="invoices" className="mt-6">
            <Card>
              <CardHeader>
                <CardTitle>Design Service Invoices</CardTitle>
                <CardDescription>Manage and track design service invoices</CardDescription>
              </CardHeader>
              <CardContent>
                {invoicesLoading ? (
                  <div className="flex items-center justify-center py-12">
                  ...
                  <div className="text-center py-12 text-muted-foreground">
                    ...
                    <p>No invoices yet</p>
                    <p className="text-sm">Create your first design service invoice</p>
                  </div>
                )}
              </CardContent>
            </Card>
