...
export default function GlobalSearchPage() {
  ...
  const sampleResults: SearchResult[] = [
    ...
    { id: "7", title: "The L.A.W.S. Collective Budget", description: "Entity financial overview and allocation details", type: "business", path: "/business", date: "Jan 5, 2026", relevance: 65 },
