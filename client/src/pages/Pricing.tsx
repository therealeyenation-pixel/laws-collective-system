  ...
  const servicePackages: ServicePackage[] = [
    {
      ...
      price: "$1,500 - $5,000",
      description: "Professional grant proposal development with research and submission support",
    ...
    },
    {
      ...
      price: "$2,000 - $10,000",
      description: "Commercial and government proposal creation for contracts and opportunities",
    ...
    },
    {
      ...
      price: "$500 - $2,500",
      description: "Contract creation, review, and ongoing management services",
    ...
    },
    {
      ...
      price: "$1,000 - $3,500",
      description: "Comprehensive business planning for startups and existing businesses",
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/10">
      ...
      <footer className="border-t border-border mt-16 py-8">
        <div className="container max-w-7xl mx-auto px-4 text-center text-sm text-muted-foreground">
          <p>© 2025 L.A.W.S. Collective. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
