...
const ENTITY_TYPES = [
  ...
  },
  {
    ...
    name: "S Corporation",
    icon: Building2,
    description: "Corporation with pass-through taxation. Ideal for businesses with profits over $40k seeking to reduce self-employment tax.",
    benefits: ["Save on self-employment tax", "Credibility with clients", "Limited liability", "Pass-through taxation"],
    considerations: ["Strict requirements", "Reasonable salary requirement", "More paperwork than LLC"],
    recommended: false,
    tokensReward: 750,
    modules: 10,
    locked: false,
  },
  {
    ...
    name: "C Corporation",
    icon: Building2,
    description: "Standard corporation with separate taxation. Best for raising investment capital or going public.",
    benefits: ["Unlimited shareholders", "Raise capital easily", "Separate taxation", "Stock options for employees"],
    considerations: ["Double taxation", "Complex compliance", "Higher costs", "Board requirements"],
    recommended: false,
    tokensReward: 700,
    modules: 12,
    locked: false,
  ...
  {
    id: "partnership",
    name: "Partnership (GP/LP/LLP)",
    icon: Users,
    description: "Business owned by two or more people. Options include General, Limited, and Limited Liability Partnerships.",
    benefits: ["Pass-through taxation", "Shared responsibility", "Flexible profit sharing", "Easy to form"],
    considerations: ["Unlimited liability (GP)", "Partner disputes", "Shared decision-making"],
    recommended: false,
    tokensReward: 500,
    modules: 8,
    locked: false,
  },
  {
    ...
    icon: Users,
    description: "Simplest business structure. You and your business are legally the same entity.",
    benefits: ["Easiest to start", "Complete control", "Simple taxes", "No formation fees"],
    considerations: ["Unlimited personal liability", "Harder to raise capital", "No asset protection"],
    recommended: false,
    tokensReward: 300,
    modules: 5,
    locked: false,
  ...
  {
    id: "98trust",
    name: "98 Trust (Constitutional Trust)",
    icon: Shield,
    description: "Sovereign trust structure based on constitutional principles. Advanced asset protection and privacy.",
    benefits: ["Maximum asset protection", "Constitutional foundation", "Privacy", "Generational wealth transfer"],
    considerations: ["Complex legal structure", "Specialized knowledge required", "Limited mainstream recognition"],
    recommended: false,
    tokensReward: 1000,
    modules: 15,
    locked: true,
  ...
  },
  {
    ...
    icon: Landmark,
    description: "Traditional tax-exempt charitable organization. Requires IRS application and approval.",
    benefits: ["Tax-exempt status", "Tax-deductible donations", "Grant eligibility", "Public trust & credibility"],
    considerations: ["IRS Form 1023 application", "Annual Form 990 filing", "Public disclosure requirements", "Operational restrictions"],
    recommended: false,
    tokensReward: 650,
    modules: 12,
    locked: false,
...
const TRAINING_MODULES: Record<string, { id: string; title: string; description: string; duration: string; quiz?: { question: string; options: string[]; correct: number }[] }[]> = {
  ...
  nonprofit501c3: [
    { id: "501c3-1", title: "501(c)(3) Fundamentals", description: "Understanding the traditional nonprofit structure and IRS requirements.", duration: "15 min" },
    { id: "501c3-2", title: "Qualifying Purposes", description: "Charitable, educational, religious, scientific, and literary purposes.", duration: "20 min" },
    { id: "501c3-3", title: "Public Charity vs Private Foundation", description: "Key differences and public support tests.", duration: "25 min" },
    { id: "501c3-4", title: "Articles of Incorporation", description: "Required provisions for 501(c)(3) status.", duration: "20 min" },
    { id: "501c3-5", title: "Bylaws & Governance", description: "Board structure, conflicts of interest, and policies.", duration: "25 min" },
    { id: "501c3-6", title: "Form 1023 Application", description: "Completing the IRS application for tax-exempt status.", duration: "45 min" },
    { id: "501c3-7", title: "Form 1023-EZ", description: "Streamlined application for smaller organizations.", duration: "20 min" },
    { id: "501c3-8", title: "Annual Filing Requirements", description: "Form 990, 990-EZ, and 990-N reporting.", duration: "30 min" },
    { id: "501c3-9", title: "Unrelated Business Income", description: "Understanding UBIT and taxable activities.", duration: "20 min" },
    { id: "501c3-10", title: "Fundraising Compliance", description: "State registration and charitable solicitation laws.", duration: "25 min" },
    { id: "501c3-11", title: "Grant Eligibility", description: "Accessing foundation and government grants.", duration: "20 min" },
    { id: "501c3-12", title: "Maintaining Tax-Exempt Status", description: "Avoiding jeopardizing activities and private benefit.", duration: "25 min" },
  ],
  collective: [
