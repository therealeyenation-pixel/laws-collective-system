...
const questions: TriviaQuestion[] = [
  ...
  { id: 8, category: "air", question: "What is the purpose of an Operating Agreement for an LLC?", options: ["Tax filing", "Defines ownership and management structure", "Marketing plan", "Employee handbook"], correctAnswer: 1, explanation: "An Operating Agreement outlines the ownership percentages, voting rights, and management responsibilities of LLC members.", difficulty: "hard" },
