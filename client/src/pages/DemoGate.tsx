      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Enter the passcode to preview the The L.A.W.S. Collective system
          </p>
        </div>
        ...
        <div className="text-center space-y-2 pt-4 border-t border-border">
          <p className="text-sm text-muted-foreground">
            This is a limited preview of the The L.A.W.S. Collective system.
          </p>
          <p className="text-xs text-muted-foreground">
            For full access, contact the The L.A.W.S. Collective team.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-sm border-b border-border">
        <div className="container max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-foreground">The L.A.W.S. Collective - Demo</h1>
      ...
      <main className="flex-1 container max-w-6xl mx-auto px-4 py-12 space-y-12">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            This is a limited preview of the full The L.A.W.S. Collective platform. Below you can see the main sections of the system.
          </p>
        </section>
        ...
        <section className="text-center space-y-6 py-12 border-t border-border">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            This demo provides a preview of the The L.A.W.S. Collective system. To access the full platform with all features enabled, contact the The L.A.W.S. Collective team.
          </p>
