...
export default function MyCredential() {
        ...
        <div className="container max-w-2xl py-12">
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Please sign in to view your The L.A.W.S. Collective Member Credential
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-base mt-2">
                Complete one of the following paths to earn your The L.A.W.S. Collective Member Credential:
              </CardDescription>
            </CardHeader>
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: "The L.A.W.S. Collective Member Credential",
        text: "Verify my The L.A.W.S. Collective membership: " + credentialId,
        url: qrData,
      });
    } else {
        ...
        <Card className="overflow-hidden">
          <div className="bg-gradient-to-r from-primary to-primary/80 p-6 text-primary-foreground">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold">The L.A.W.S. Collective</h1>
