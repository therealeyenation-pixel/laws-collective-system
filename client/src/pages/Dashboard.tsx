...
export default function Dashboard() {
  ...
  const downloadBusinessPlan = () => {
    ...
    content += "*This comprehensive plan was generated through The The The L.A.W.S. Collective, LLC Business Setup Courses.*\n";
      ...
      <div className="space-y-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">
            The The The L.A.W.S. Collective, LLC Dashboard
          </h1>
