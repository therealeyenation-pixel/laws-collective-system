...
export const DIALOGUE_TREES: DialogueTree[] = [
  ...
  // Guide Compass Dialogue (Tutorial/Hub)
  {
    ...
    nodes: {
      ...
      "tutorial-tokens": {
        id: "tutorial-tokens",
        text: "Tokens are the currency of L.A.W.S. Quest. Earn them by completing quests and daily logins. Spend them at shops to buy helpful items. In the future, tokens may connect to real-world benefits through the The L.A.W.S. Collective!",
        choices: [
          { text: "How do quests work?", nextNodeId: "tutorial-quests" },
          { text: "How do I level up?", nextNodeId: "tutorial-levels" },
          { text: "Let me ask about something else.", nextNodeId: "root" },
