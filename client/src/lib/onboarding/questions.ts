...
export const LAND_QUESTIONS: OnboardingQuestion[] = [
  ...
  },
  {
    id: 'land_q8',
    realm: 'land',
    questionText: 'What is the "House" concept in the L.A.W.S. Collective?',
    options: [
      'A physical building',
    ...
    correctOptionIndex: 1,
    explanation: 'In the L.A.W.S. Collective, a House is a personal or family trust structure that helps you manage, protect, and grow assets across generations.',
    difficulty: 'easy'
  }
];
