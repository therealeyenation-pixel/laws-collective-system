# LuvOnPurpose Family Enterprise
## Career Opportunities

**Organization:** Calea Freeman Family Trust & Subsidiary Entities  
**Mission:** Building Multi-Generational Wealth Through Purpose & Community

---

## About Us

The LuvOnPurpose Family Enterprise is a multi-entity organization focused on community development, education, media production, and wealth building. We operate through five subsidiary entities, each serving a specific purpose in our mission to create lasting prosperity for families and communities.

Our entities include educational programs, media production, community outreach, and business development services. We are seeking passionate individuals who believe in family, community, and building something that lasts.
...
- Design and manage comprehensive onboarding programs
- Coordinate training paths with Academy leadership
- Implement performance evaluation frameworks
- Serve as first point of contact for workplace concerns

**Requirements:**
- 3+ years experience in human resources or recruiting
...
- Review work outputs before delivery
- Develop and maintain Standard Operating Procedures
- Ensure adherence to grant requirements
- Lead continuous improvement initiatives

**Requirements:**
- 3+ years experience in quality assurance or compliance
...
- Provide cost estimates for grant proposals
- Maintain inventory tracking system
- Ensure purchases comply with grant requirements

**Requirements:**
- 2+ years experience in purchasing or procurement
- Strong negotiation skills
- Proficiency with spreadsheets and inventory systems
...
The Operations Manager ensures smooth day-to-day operations across all subsidiary entities. This role coordinates workflows, monitors business systems, identifies bottlenecks, and provides support to team members.

**Key Responsibilities:**
- Coordinate workflows between entities
- Monitor business systems for performance
...
**Entity:** LuvOnPurpose Outreach Temple and Academy Society, Inc.  
**Location:** Hybrid (community events + remote coordination)  
**Type:** Full-Time  
**Salary Range:** $42,000 - $58,000 annually

The Outreach Coordinator connects the organization with the broader community through events, partnerships, and relationship building. This role plans community events, builds partner relationships, and coordinates volunteers.
...
- Coordinate with Media team on event promotion

**Requirements:**
- 2+ years experience in community outreach or event planning
...
**Location:** Remote with on-location shoots as needed  
**Type:** Part-Time to Full-Time  
**Salary Range:** $35,000 - $55,000 annually (full-time equivalent)

The Content Creator supports the media production mission by creating social media content, documenting events, editing videos, and writing copy for marketing materials.

**Key Responsibilities:**
- Create engaging social media content
- Document events and programs through photo/video
- Edit videos for tutorials and promotional content
- Write copy for posts, emails, and marketing materials
- Support digital asset creation

**Requirements:**
- Demonstrated content creation experience (portfolio required)
- Proficiency with smartphone photography and videography
...
**Entity:** LuvOnPurpose Outreach Temple and Academy Society, Inc.  
**Location:** Remote with occasional in-person sessions  
**Type:** Part-Time to Full-Time  
**Salary Range:** $40,000 - $65,000 annually (full-time equivalent)

The Academy Instructor delivers educational content and develops new courses for the LuvOnPurpose Academy. This role teaches courses, creates curriculum, develops assessments, and tracks student progress.

**Key Responsibilities:**
- Deliver courses in assigned subject areas
- Design new courses based on organizational needs
- Create assessments and track student progress
- Issue certificates upon completion
- Continuously improve based on feedback

**Requirements:**
- Expertise in at least one subject area (finance, business, technology, writing, etc.)
...
The Grant Writer identifies funding opportunities and writes compelling proposals to secure grants for all subsidiary entities. This role researches opportunities, develops narratives, creates budgets, and manages deadlines.

**Key Responsibilities:**
- Research grant opportunities matched to each entity
- Write compelling narratives and proposals
- Develop budgets with Purchasing and Finance
- Manage multiple concurrent applications
- Track outcomes and prepare progress reports
...
The Platform Administrator maintains and improves the technology infrastructure of the organization. This role monitors system health, manages user accounts, implements new features, and ensures security.

**Key Responsibilities:**
- Monitor platform health and performance
- Create and manage user accounts
- Implement new features as platform grows
- Ensure security of sensitive data
- Train users on platform features

**Requirements:**
- 2+ years experience in IT administration
- Comfortable with technology and quick to learn
...
The Community Programs Coordinator develops and manages programs based on the L.A.W.S. framework (Land, Air, Water, Self) that help community members reconnect with their roots, gain knowledge, find balance, and discover purpose.
...
- Opportunity to grow with a developing organization

**Remote Work Support:**
- Monthly utilities stipend (internet and electricity support)
- Equipment provided (laptop, phone, software)
...
Additional benefits are discussed during the interview process and vary by position and experience level.

---

## How to Apply

1. **Express Interest** - Complete the interest form on our Careers page
2. **Initial Review** - Our HR team will review your submission
3. **Interview** - Selected candidates will be contacted for interviews
4. **Onboarding** - Successful candidates complete our Academy orientation
5. **Assignment** - Receive your role and responsibilities
...
*We are an equal opportunity organization committed to diversity and inclusion.*
