...
const DISPUTE_RESOLUTION_TEMPLATES = {
  ...
  LAWS_MEMBER_DISPUTE_PROTOCOL: {
    ...
    templateName: "The L.A.W.S. Collective Member Dispute Resolution Protocol",
    category: "dispute_resolution" as const,
    description: "Internal dispute resolution protocol for The L.A.W.S. Collective members",
    pageSize: "letter" as const,
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const htmlContent = `
        ...
        <body>
          ...
          <div class="footer">
            <p>This report is generated by the The L.A.W.S. Collective Financial Automation System.</p>
