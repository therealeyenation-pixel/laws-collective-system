...
<body><div class="document-container">
  ...
  <div class="article"><div class="article-title">CAREER PATHWAY</div>
    <div class="pathway-box">
      ...
      <li><strong>Business Owner:</strong> The L.A.W.S. Collective member with own enterprise (FUTURE)</li></ol>
    </div>
  </div>
...
<body><div class="document-container">
  ...
  <div class="article"><div class="article-title">CAREER PATHWAY COMPLETION</div>
    <div class="pathway-box">
      ...
      <li><strong>Business Owner:</strong> The L.A.W.S. Collective member with own enterprise ✓ <strong>(ACHIEVED)</strong></li></ol>
    </div>
  </div>
...
export const internshipTransitionRouter = router({
  ...
  getCareerPathway: protectedProcedure.query(() => {
    return [
      ...
      { stage: 4, name: "Business Owner", description: "The L.A.W.S. Collective member with own enterprise", status: "achievement" },
    ];
  }),
