...
export const gameCenterRouter = router({
  ...
  seedGames: protectedProcedure.mutation(async () => {
    ...
    const games = [
      ...
      { name: "Escape Rooms", slug: "escape-rooms", description: "Solve puzzles to escape themed rooms", gameType: "mystery", ageGroup: "6_8", minPlayers: 1, maxPlayers: 4, estimatedDuration: "30-45 min", skillsTargeted: ["problem-solving", "teamwork", "critical-thinking"], tokenRewardBase: 15, icon: "key" },
      ...
      { name: "Crossword Master", slug: "crossword-master", description: "Advanced crossword puzzles", gameType: "word", ageGroup: "9_12", minPlayers: 1, maxPlayers: 1, estimatedDuration: "15-30 min", skillsTargeted: ["vocabulary", "general-knowledge", "problem-solving"], tokenRewardBase: 10, icon: "hash" },
      ...
      { name: "Spades", slug: "spades", description: "Classic trick-taking card game with bidding strategy", gameType: "card", ageGroup: "9_12", minPlayers: 4, maxPlayers: 4, estimatedDuration: "30-45 min", skillsTargeted: ["strategy", "probability", "partnership", "memory"], tokenRewardBase: 15, icon: "spade" },
      { name: "Yahtzee", slug: "yahtzee", description: "Dice game of probability and decision-making", gameType: "board", ageGroup: "6_8", minPlayers: 1, maxPlayers: 4, estimatedDuration: "20-30 min", skillsTargeted: ["probability", "decision-making", "risk-assessment", "math"], tokenRewardBase: 10, icon: "puzzle" },
      { name: "Scrabble", slug: "scrabble", description: "Build words for points - expand your vocabulary", gameType: "word", ageGroup: "6_8", minPlayers: 2, maxPlayers: 4, estimatedDuration: "45-60 min", skillsTargeted: ["vocabulary", "spelling", "strategy", "spatial-reasoning"], tokenRewardBase: 15, icon: "text" },
      { name: "Dominoes", slug: "dominoes", description: "Classic tile-matching game of strategy", gameType: "board", ageGroup: "k_5", minPlayers: 2, maxPlayers: 4, estimatedDuration: "15-30 min", skillsTargeted: ["pattern-matching", "math", "strategy", "planning"], tokenRewardBase: 8, icon: "puzzle" },
      { name: "Mancala", slug: "mancala", description: "Ancient African counting and capture strategy game", gameType: "strategy", ageGroup: "k_5", minPlayers: 2, maxPlayers: 2, estimatedDuration: "15-25 min", skillsTargeted: ["counting", "strategy", "planning-ahead", "math"], tokenRewardBase: 10, icon: "circle" },
      { name: "Mahjong Solitaire", slug: "mahjong-solitaire", description: "Match pairs of tiles to clear the board", gameType: "puzzle", ageGroup: "all_ages", minPlayers: 1, maxPlayers: 1, estimatedDuration: "10-20 min", skillsTargeted: ["pattern-recognition", "memory", "concentration", "spatial-reasoning"], tokenRewardBase: 12, icon: "puzzle" },
      { name: "Backgammon", slug: "backgammon", description: "Ancient strategy game combining skill and probability", gameType: "board", ageGroup: "9_12", minPlayers: 2, maxPlayers: 2, estimatedDuration: "15-30 min", skillsTargeted: ["probability", "strategy", "decision-making", "planning"], tokenRewardBase: 15, icon: "circle-dot" },
      { name: "Tangram", slug: "tangram", description: "Arrange geometric shapes to form patterns", gameType: "puzzle", ageGroup: "k_5", minPlayers: 1, maxPlayers: 1, estimatedDuration: "5-15 min", skillsTargeted: ["spatial-reasoning", "geometry", "creativity", "problem-solving"], tokenRewardBase: 10, icon: "puzzle" },
      { name: "Word Ladder", slug: "word-ladder", description: "Transform words by changing one letter at a time", gameType: "word", ageGroup: "6_8", minPlayers: 1, maxPlayers: 1, estimatedDuration: "5-10 min", skillsTargeted: ["vocabulary", "spelling", "word-relationships", "problem-solving"], tokenRewardBase: 10, icon: "ladder" },
      { name: "L.A.W.S. Trivia Challenge", slug: "trivia-challenge", description: "Test knowledge across Land, Air, Water, and Self pillars", gameType: "trivia", ageGroup: "all_ages", minPlayers: 1, maxPlayers: 4, estimatedDuration: "10-20 min", skillsTargeted: ["general-knowledge", "recall", "quick-thinking", "laws-pillars"], tokenRewardBase: 15, icon: "brain" },
      { name: "Simon Says", slug: "simon-says", description: "Memory sequence game - watch and repeat the pattern", gameType: "puzzle", ageGroup: "k_5", minPlayers: 1, maxPlayers: 1, estimatedDuration: "5-10 min", skillsTargeted: ["memory", "attention", "auditory-memory", "sequence-recall"], tokenRewardBase: 8, icon: "brain" },
    ];
